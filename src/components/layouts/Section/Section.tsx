...
export const commonTop: CSSProperties["top"] =
  "max(0.5rem, env(safe-area-inset-top))";
export const commonBottom: CSSProperties["bottom"] =
  "max(0.5rem, env(safe-area-inset-bottom))";
export const commonLeft: CSSProperties["left"] =
  "max(0.5rem, env(safe-area-inset-left))";
export const commonRight: CSSProperties["right"] =
